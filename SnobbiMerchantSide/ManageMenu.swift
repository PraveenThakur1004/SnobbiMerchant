...
public struct Item {
    ...
    var image:String
    var menu_id:String
    public init(name: String, price: String, id:String, menu_id:String,image:String) {
        self.name = name
        self.price = price
        self.id = id
...
public struct Section {
    ...
    var items: [Item]
    var collapsed: Bool
    public init(name: String, id:String, items: [Item], collapsed: Bool = false) {
        self.name = name
        self.id = id
        self.items = items
